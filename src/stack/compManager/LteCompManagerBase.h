...
protected:
    ...
    void handleX2Message(Packet* pkt);
    //void sendClientRequest(X2CompRequestIE* requestIe);
    void sendClientRequest(Packet *);
    //void sendCoordinatorReply(X2NodeId clientId, X2CompReplyIE* replyIe);
    void sendCoordinatorReply(X2NodeId clientId, Packet* replyIe);
    ...
    virtual Packet* buildClientRequest() = 0;
    virtual void handleClientRequest(Packet *) = 0;

    //virtual X2CompReplyIE* buildCoordinatorReply(X2NodeId clientId) = 0;
    virtual Packet* buildCoordinatorReply(X2NodeId clientId) = 0;
    virtual void handleCoordinatorReply(Packet* ) = 0;
