...
protected:
    ...
    virtual Packet* buildClientRequest();
    //virtual void handleClientRequest(X2CompMsg* compMsg);
    virtual void handleClientRequest(Packet* compMsg);

    //virtual X2CompProportionalReplyIE* buildCoordinatorReply(X2NodeId clientId);
    virtual Packet* buildCoordinatorReply(X2NodeId clientId);
    //virtual void handleCoordinatorReply(X2CompMsg* compMsg);
    virtual void handleCoordinatorReply(Packet* compMsg);
