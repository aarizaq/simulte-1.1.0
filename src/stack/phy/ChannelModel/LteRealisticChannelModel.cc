...
std::vector<double> LteRealisticChannelModel::getSINR(LteAirFrame *frame, UserControlInfo* lteInfo)
{
   ...
   if (dir == DL)
   {
       ...
       LtePhyBase* ltePhy = eNbModule ?
          check_and_cast<LtePhyBase*>(eNbModule->getSubmodule("wlanLteNic")->getSubmodule("phy")) :
          nullptr;
...
LteRealisticChannelModel::JakesFadingMap * LteRealisticChannelModel::obtainUeJakesMap(MacNodeId id)
{
   ...
   LtePhyBase * ltePhy = check_and_cast<LtePhyBase*>(
           getSimulation()->getModule(binder_->getOmnetId(id))->getSubmodule("wlanLteNic")->getSubmodule("phy"));
       ...
       std::vector<double> * interference)
{
   ...
   while(it!=et)
   {
       ...
       if(!(*it)->init)
       {
           ...
           ltePhy = check_and_cast<LtePhyBase*>(getSimulation()->getModule(binder_->getOmnetId(id))->getSubmodule("wlanLteNic")->getSubmodule("phy"));
