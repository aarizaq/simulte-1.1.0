...
{
  protected:
    virtual void handleControlInfo(cPacket* upPkt, FlowControlInfo* lteInfo) override
    {
        delete lteInfo;
    }
...
{
  protected:
    void handleControlInfo(cPacket* upPkt, FlowControlInfo* lteInfo) override
    {
        delete lteInfo;
    }
...
class LtePdcpRrcRelayEnb : public LtePdcpRrcBase
{
  protected:
    void handleControlInfo(cPacket* upPkt, FlowControlInfo* lteInfo) override
    {
        auto pkt = check_and_cast<inet::Packet *>(upPkt);
