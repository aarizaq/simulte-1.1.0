...
class X2AppClient : public inet::SctpClient
{
  ...
  protected:
    ...
    //void socketDataArrived(int32_t connId, void *yourPtr, Packet *msg, bool urgent) override;
    void socketEstablished(inet::SctpSocket *socket, unsigned long int buffer) override;    // TODO: needs a better name
    void socketDataArrived(inet::SctpSocket *socket, inet::Packet *msg, bool urgent) override;    // TODO: needs a better name
};
